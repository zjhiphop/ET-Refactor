	  ...
	  */
	  ...
	  $(s.slider_bar).slider({
		...
		$(s.epaper_corner).mousedown(function(e){
			...
			epaper.draggable({ disabled: true });
		})
		$(window.document).mousemove(function(e){	
			...
			epaper.draggable({ disabled: false });			
		});
	},
	...
	$e.fn.extend({
		meta:{
			  ...
			  get: function( elem, opts ){
					...
					if ( !settings.metaCache.length ) settings.metaCache = 'metadata';
					...
					if ( settings.metaType == "class" ) {
						...
						if ( m )
							data = m[1];
						console.log(m);
					} else if ( settings.metaType == "elem" ) {
        ...
        **/
        center: function()
        {
            this.setCoords(-Math.round((this.img_object.display_height - this.defaults.height)/2),
                           -Math.round((this.img_object.display_width - this.defaults.width)/2));
        },
        ...
        **/
        containerToImage : function (x,y)
        {
            ...
            return { x :  $e.descaleValue(x - this.img_object.x, this.current_zoom),
        ...
        **/
        imageToContainer : function (x,y)
        {
            ...
            return { x : this.img_object.x + $e.scaleValue(x, this.current_zoom),
        ...
        **/
        getMouseCoords : function(e)
        {
            ...
            return { x : $e.descaleValue(e.pageX - img_offset.left, this.current_zoom),
        ...
        **/
        set_zoom: function(new_zoom)
        {
            ...
            else if(new_zoom > this.defaults.zoom_max)
            {
            ...
            if(this.current_zoom == "fit")
            {
                ...
                var old_x = -parseInt(this.img_object.object.css("left"),10) +
                                            Math.round(this.defaults.width/2);
                var old_y = -parseInt(this.img_object.object.css("top"),10) + 
                                            Math.round(this.defaults.height/2);
            }
        ...
        **/
        find_closest_zoom_rate: function(value)
        {
            ...
            while(Math.abs(func(this.defaults.zoom_base, Math.pow(mltplr,rate)) - value) > 
                  Math.abs(func(this.defaults.zoom_base, Math.pow(mltplr,rate+1)) - value))
            {
                rate++;
            }
        ...
        **/
        ...
        {
			// Zhiming
            if(this.defaults.onStartDrag && 
               this.defaults.onStartDrag.call(this,this.getMouseCoords(e)) == false)
            {
                return false;
            }
        ...
        **/
        drag: function(e)
        {
            this.defaults.onMouseMove && 
                    this.defaults.onMouseMove.call(this,this.getMouseCoords(e));
            
            if(this.dragged){
                this.defaults.onDrag && 
                        this.defaults.onDrag.call(this,this.getMouseCoords(e));
        ...
        **/
        ...
        click: function(e)
        {
            this.defaults.onClick && 
                    this.defaults.onClick.call(this,this.getMouseCoords(e));
        },
        ...
        **/
        createui: function()
        {
            ...
            $("<div>").addClass("epaper_zoom_in").addClass("epaper_common").
            addClass("epaper_button").
            mousedown(function(){me.zoom_by(1); return false;}).appendTo(this.container);
            
            $("<div>").addClass("epaper_zoom_out").addClass("epaper_common").
            addClass("epaper_button").
            mousedown(function(){me.zoom_by(- 1); return false;}).appendTo(this.container);
            
            $("<div>").addClass("epaper_zoom_zero").addClass("epaper_common").
            addClass("epaper_button").
            mousedown(function(){me.set_zoom(100); return false;}).appendTo(this.container);
            
            $("<div>").addClass("epaper_zoom_fit").addClass("epaper_common").
            addClass("epaper_button").resize().appendTo(this.container);
        },
